...
public class Base64 {
	...
	public  static bool DECODE = false;
	 ...
	 */
	private  static byte[] ALPHABET = { (byte) 'A', (byte) 'B',
	 ...
	 */
	private  static byte[] WEBSAFE_ALPHABET = { (byte) 'A', (byte) 'B',
			(byte) 'C', (byte) 'D', (byte) 'E', (byte) 'F', (byte) 'G',
			(byte) 'H', (byte) 'I', (byte) 'J', (byte) 'K', (byte) 'L',
			(byte) 'M', (byte) 'N', (byte) 'O', (byte) 'P', (byte) 'Q',
			(byte) 'R', (byte) 'S', (byte) 'T', (byte) 'U', (byte) 'V',
	 ...
	 **/
	private  static byte[] DECODABET = { -9, -9, -9, -9, -9, -9, -9, -9,
			-9, // Decimal 0 - 8
	...
	private  static byte[] WEBSAFE_DECODABET = { -9, -9, -9, -9, -9, -9,
			-9, -9, -9, // Decimal 0 - 8
			-5, -5, // Whitespace: Tab and Linefeed
			-9, -9, // Decimal 11 - 12
			-5, // Whitespace: Carriage Return
	...
	private  static byte WHITE_SPACE_ENC = -5;
	// Indicates equals sign in encoding
	private  static byte EQUALS_SIGN_ENC = -1;
	 ...
	 */
	public static String encodeWebSafe(byte[] source, bool doPadding) {

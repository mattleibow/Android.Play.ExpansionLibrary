// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IDownloaderClient.cs" company="Matthew Leibowitz">
...
namespace ExpansionDownloader.Client
{
    ...
    public interface IDownloaderClient
    {
        ...
        /// <see cref="DownloaderState.Downloading"/>.
        /// </summary>
        /// <param name="progress">
        ...
        /// <see cref="ExpansionDownloader.Service.Helpers.GetDownloaderStringFromState"/>.
        /// </para>
        /// <para>
        ...
        /// </param>
        void OnDownloadStateChanged(DownloaderState newState);
        ...
        /// <see cref="ExpansionDownloader.Service.ServiceMarshaller.CreateProxy"/>
        /// to instantiate a member instance of 
        /// <see cref="ExpansionDownloader.Service.IDownloaderService"/>, 
        /// then call 
        /// <see cref="ExpansionDownloader.Service.IDownloaderService.OnClientUpdated"/> 
